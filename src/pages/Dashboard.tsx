...
const Dashboard = () => {
  ...
  const fetchUsageData = async () => {
    ...
    const mockData = [
      ...
      { name: "Tue", operations: 8 },
      { name: "Wed", operations: 3 },
      { name: "Thu", operations: 12 },
      { name: "Fri", operations: 7 },
      { name: "Sat", operations: 15 },
      { name: "Sun", operations: 9 },
    ];
    setUsageData(mockData);
    setTotalOperations(mockData.reduce((sum, day) => sum + day.operations, 0));
    setTodayOperations(mockData[mockData.length - 1].operations);
  };
