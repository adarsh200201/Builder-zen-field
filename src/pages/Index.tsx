        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-12">
            ...
            <p className="text-body-medium text-text-light mb-6 max-w-xs">
              The most popular free PDF tools to merge, split, compress, convert, rotate, unlock and watermark PDFs. 100% free online tools.
            </p>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <a href="#" className="w-10 h-10 bg-blue-800 hover:bg-blue-900 rounded-lg flex items-center justify-center transition-colors duration-200">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <a href="#" className="w-10 h-10 bg-black hover:bg-gray-800 rounded-lg flex items-center justify-center transition-colors duration-200">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* PDF Tools */}
              <div>
                <h4 className="font-semibold text-text-dark mb-4">Popular Tools</h4>
                <ul className="space-y-3">
                  <li><Link to="/merge" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Merge PDF</Link></li>
                  <li><Link to="/split" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Split PDF</Link></li>
                  <li><Link to="/compress" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Compress PDF</Link></li>
                  <li><Link to="/pdf-to-word" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">PDF to Word</Link></li>
                  <li><Link to="/word-to-pdf" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Word to PDF</Link></li>
                  <li><Link to="/pdf-to-jpg" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">PDF to JPG</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li><Link to="/jpg-to-pdf" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">JPG to PDF</Link></li>
                  <li><Link to="/pdf-to-powerpoint" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">PDF to PowerPoint</Link></li>
                  <li><Link to="/pdf-to-excel" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">PDF to Excel</Link></li>
                  <li><Link to="/powerpoint-to-pdf" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">PowerPoint to PDF</Link></li>
                  <li><Link to="/excel-to-pdf" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Excel to PDF</Link></li>
                  <li><Link to="/html-to-pdf" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">HTML to PDF</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li><Link to="/pricing" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Pricing</Link></li>
                  <li><Link to="/desktop" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Desktop App</Link></li>
                  <li><Link to="/mobile" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Mobile App</Link></li>
                  <li><Link to="/api" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Developer API</Link></li>
                  <li><Link to="/features" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Features</Link></li>
                  <li><Link to="/help" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Help Center</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-3">
                  <li><Link to="/about" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">About Us</Link></li>
                  <li><Link to="/blog" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Blog</Link></li>
                  <li><Link to="/press" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Press</Link></li>
                  <li><Link to="/careers" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Careers</Link></li>
                  <li><Link to="/contact" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Contact</Link></li>
                  <li><Link to="/affiliate" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Affiliate Program</Link></li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <p className="text-body-small text-text-light">
              © 2025 PdfPage. All rights reserved.
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <Link to="/cookies" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Cookies</Link>
                  <Link to="/security" className="text-body-small text-text-light hover:text-brand-red transition-colors duration-200">Security</Link>
                </div>
              </div>
